...
i386-elf-g++ -Wall -ffreestanding -m32 -g -c "./src/kernel/kernel.cpp" -o "Binaries/kernel.o"
i386-elf-g++ -Wall -ffreestanding -m32 -g -c "./src/drivers/vga.cpp" -o "Binaries/vga.o"
